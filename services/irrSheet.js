const irregularVerbs = [
  { infinitive: "be", past: "was/were", participle: "been", translation: "быть, находиться" },
  ...
  { infinitive: "bite", past: "bit", participle: "bitten", translation: "кусать" },
  { infinitive: "blow", past: "blew", participle: "blown", translation: "дуть" },
  { infinitive: "break", past: "broke", participle: "broken", translation: "ломать, разрушать" },
  ...
  { infinitive: "catch", past: "caught", participle: "caught", translation: "ловить, поймать" },
  { infinitive: "choose", past: "chose", participle: "chosen", translation: "выбирать" },
  { infinitive: "come", past: "came", participle: "come", translation: "приходить, приезжать" },
  { infinitive: "cost", past: "cost", participle: "cost", translation: "стоить" },
  { infinitive: "cut", past: "cut", participle: "cut", translation: "резать" },
  { infinitive: "dig", past: "dug", participle: "dug", translation: "копать" },
  { infinitive: "do", past: "did", participle: "done", translation: "делать" },
  { infinitive: "draw", past: "drew", participle: "drawn", translation: "рисовать, чертить" },
  { infinitive: "dream", past: "dreamt", participle: "dreamt", translation: "мечтать, видеть сон" },
  { infinitive: "drink", past: "drank", participle: "drunk", translation: "пить" },
  { infinitive: "drive", past: "drove", participle: "driven", translation: "водить, ехать" },
  { infinitive: "eat", past: "ate", participle: "eaten", translation: "есть, кушать" },
  ...
  { infinitive: "fight", past: "fought", participle: "fought", translation: "драться, бороться" },
  ...
  { infinitive: "get", past: "got", participle: "got/gotten", translation: "получать, добираться" },
  { infinitive: "give", past: "gave", participle: "given", translation: "давать" },
  { infinitive: "go", past: "went", participle: "gone", translation: "идти, ехать" },
  ...
  { infinitive: "hide", past: "hid", participle: "hidden", translation: "прятать, прятаться" },
  { infinitive: "hit", past: "hit", participle: "hit", translation: "ударять" },
  { infinitive: "hold", past: "held", participle: "held", translation: "держать" },
  { infinitive: "hurt", past: "hurt", participle: "hurt", translation: "ранить, причинять боль" },
  { infinitive: "keep", past: "kept", participle: "kept", translation: "хранить, держать" },
  { infinitive: "know", past: "knew", participle: "known", translation: "знать" },
  { infinitive: "learn", past: "learnt/learned", participle: "learnt/learned", translation: "учить, узнавать" },
  { infinitive: "leave", past: "left", participle: "left", translation: "покидать, оставлять" },
  ...
  { infinitive: "make", past: "made", participle: "made", translation: "делать, создавать" },
  { infinitive: "mean", past: "meant", participle: "meant", translation: "означать, иметь в виду" },
  ...
  { infinitive: "put", past: "put", participle: "put", translation: "класть, ставить" },
  { infinitive: "read", past: "read", participle: "read", translation: "читать" },
  { infinitive: "ride", past: "rode", participle: "ridden", translation: "ездить верхом" },
  { infinitive: "ring", past: "rang", participle: "rung", translation: "звенеть, звонить" },
  { infinitive: "run", past: "ran", participle: "run", translation: "бежать" },
  { infinitive: "say", past: "said", participle: "said", translation: "сказать" },
  ...
  { infinitive: "spend", past: "spent", participle: "spent", translation: "тратить, проводить (время)" },
  ...
  { infinitive: "teach", past: "taught", participle: "taught", translation: "учить, обучать" },
  ...
  { infinitive: "freeze", past: "froze", participle: "frozen", translation: "замерзать, замораживать" },
  { infinitive: "hang", past: "hung", participle: "hung", translation: "вешать, висеть" },
  { infinitive: "lay", past: "laid", participle: "laid", translation: "класть, положить" },
  { infinitive: "lead", past: "led", participle: "led", translation: "вести, руководить" },
  { infinitive: "let", past: "let", participle: "let", translation: "позволять, разрешать" },
  { infinitive: "lie", past: "lay", participle: "lain", translation: "лежать" },
  { infinitive: "rise", past: "rose", participle: "risen", translation: "подниматься, вставать" },
  { infinitive: "set", past: "set", participle: "set", translation: "устанавливать, садиться (о солнце)" },
  ...
  { infinitive: "spoil", past: "spoilt/spoiled", participle: "spoilt/spoiled", translation: "портить" },
  ...
  { infinitive: "wake", past: "woke", participle: "woken", translation: "просыпаться, будить" },
  { infinitive: "wear", past: "wore", participle: "worn", translation: "носить (одежду)" },
  { infinitive: "win", past: "won", participle: "won", translation: "побеждать" },
